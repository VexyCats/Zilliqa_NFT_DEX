    ...
    ***************************************************************************** */
    ...
    var WebSocketProvider = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    ...
                    if (this.subscriptions !== null && !event.wasClean) {
                        this.emitter.emit("reconnect" /* RECONNECT */, event);
                        this.reconnect();
                        return [2 /*return*/];
                    }
                    // normal close
                    if (this.websocket.CONNECTING) {
                        this.emitter.emit("close" /* CLOSE */, event);
        ...
        WebSocketProvider.prototype.onError = function (event) {
            this.emitter.emit("error" /* ERROR */, event);
            if (this.websocket.CONNECTING) {
                this.websocket.close();
            }
            return;
        ...
        WebSocketProvider.prototype.onMessage = function (msg) {
            ...
            if (msg.data) {
                ...
                if (dataObj.type === "Notification" /* NOTIFICATION */) {
                    this.emitter.emit("socket_message" /* SOCKET_MESSAGE */, dataObj);
                    try {
                        for (var _b = __values(dataObj.values), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var value = _c.value;
                            if (value.query === "NewBlock" /* NEW_BLOCK */) {
                                this.emitter.emit("NewBlock" /* NEW_BLOCK */, value);
                            }
                            else if (value.query === "EventLog" /* EVENT_LOG */) {
                                this.emitter.emit("EventLog" /* EVENT_LOG */, value);
                            }
                            else if (value.query === "Unsubscribe" /* UNSUBSCRIBE */) {
                                this.emitter.emit("Unsubscribe" /* UNSUBSCRIBE */, value);
                            }
                            else {
                ...
                else if (dataObj.query === "NewBlock" /* NEW_BLOCK */) {
                    // subscribe NewBlock succeed
                    this.subscriptions[dataObj.query] = {
                        id: dataObj.query,
                        parameters: dataObj,
                    };
                    this.emitter.emit("SubscribeNewBlock" /* SUBSCRIBE_NEW_BLOCK */, dataObj);
                    this.emitter.emit("reconnect" /* RECONNECT */);
                }
                else if (dataObj.query === "EventLog" /* EVENT_LOG */) {
                    // subscribe EventLog succeed
                    this.subscriptions[dataObj.query] = {
                        id: dataObj.query,
                        parameters: dataObj,
                    };
                    this.emitter.emit("SubscribeEventLog" /* SUBSCRIBE_EVENT_LOG */, dataObj);
                    this.emitter.emit("reconnect" /* RECONNECT */);
                }
                else if (dataObj.query === "Unsubscribe" /* UNSUBSCRIBE */) {
                    this.emitter.emit("Unsubscribe" /* UNSUBSCRIBE */, dataObj);
                }
                else {
        ...
        WebSocketProvider.prototype.send = function (query) {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this.connecting()) {
                    ...
                    if (query.query === "NewBlock" /* NEW_BLOCK */) {
                        queryParam = "SubscribeNewBlock" /* SUBSCRIBE_NEW_BLOCK */;
                    }
                    else if (query.query === "EventLog" /* EVENT_LOG */) {
                        queryParam = "SubscribeEventLog" /* SUBSCRIBE_EVENT_LOG */;
                    }
                    else {
                ...
                var offConnectHandler = function () {
                    _this.emitter.off("connect" /* CONNECT */, connectHandler);
                };
                _this.emitter.on("connect" /* CONNECT */, connectHandler);
                _this.emitter.on("reconnect" /* RECONNECT */, offConnectHandler);
            });
        };
    ...
    var Subscription = /** @class */ (function (_super) {
        ...
        Subscription.prototype.stop = function () {
            return __awaiter(this, void 0, void 0, function () {
                var event;
                return __generator(this, function (_a) {
                    event = this.subject.query === "NewBlock" /* NEW_BLOCK */
                        ? {
                            query: "Unsubscribe" /* UNSUBSCRIBE */,
                            type: "NewBlock" /* NEW_BLOCK */,
                        }
                        : { query: "Unsubscribe" /* UNSUBSCRIBE */, type: "EventLog" /* EVENT_LOG */ };
    ...
    var NewTxBlockSubscription = /** @class */ (function (_super) {
        ...
        function NewTxBlockSubscription(url, options) {
            return _super.call(this, { query: "NewBlock" /* NEW_BLOCK */ }, url, options) || this;
        }
    ...
    var NewEventSubscription = /** @class */ (function (_super) {
        ...
        function NewEventSubscription(url, options) {
            var _this = _super.call(this, { query: "EventLog" /* EVENT_LOG */ }, url, options) || this;
            _this.subject = {
                query: 'EventLog',
