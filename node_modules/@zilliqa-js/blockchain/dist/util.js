...
function toTxParams(response) {
    ...
    var msg = receipt.errors
        ...
        : {};
    return tslib_1.__assign(tslib_1.__assign({}, rest), { version: parseInt(version, 10), toAddr: crypto_1.toChecksumAddress(toAddr), pubKey: senderPubKey.replace('0x', ''), gasPrice: new util_1.BN(gasPrice), gasLimit: util_1.Long.fromString(gasLimit, 10), amount: new util_1.BN(amount), nonce: parseInt(nonce, 10), receipt: tslib_1.__assign(tslib_1.__assign({}, receipt), { errors: msg, cumulative_gas: parseInt(receipt.cumulative_gas, 10) }) });
}
