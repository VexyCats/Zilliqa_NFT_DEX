import { TransactionError, GET_TX_ATTEMPTS, sign } from '@zilliqa-js/core';
...
function toTxParams(response) {
    ...
    var msg = receipt.errors
        ...
        : {};
    return __assign(__assign({}, rest), { version: parseInt(version, 10), toAddr: toChecksumAddress(toAddr), pubKey: senderPubKey.replace('0x', ''), gasPrice: new BN(gasPrice), gasLimit: Long.fromString(gasLimit, 10), amount: new BN(amount), nonce: parseInt(nonce, 10), receipt: __assign(__assign({}, receipt), { errors: msg, cumulative_gas: parseInt(receipt.cumulative_gas, 10) }) });
}
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.provider.send("CreateTransaction" /* CreateTransaction */, __assign(__assign({}, tx.txParams), { priority: tx.toDS }))];
                    case 1:
                        response = _a.sent();
                        if (response.error) {
